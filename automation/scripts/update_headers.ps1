...
<p align="center">
  <a href="$($rootPath)README.md">Home</a> | <a href="$($rootPath)projects/projects.md">Projects</a> | <a href="$($rootPath)research/research.md">Research</a> | <a href="$($rootPath)techstack/techstack.md">Tech Stack</a> | <a href="$($rootPath)contact.md">Contact</a>
</p>
