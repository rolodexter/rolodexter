...
[Bitcoin](/literary_products/joes_notes/BITCOIN.md) is the **first major cryptocurrency** that sparked the global adoption of **[digital assets](/literary_products/joes_notes/CRYPTOCURRENCIES.md)** and **blockchain** technology. Introduced in a 2008 white paper by the pseudonymous **Satoshi Nakamoto**, Bitcoin serves as both a **medium of exchange** and a **store of value** within a **[decentralized](/literary_products/joes_notes/GOVERNANCE_MODELS.md#decentralized-autonomous-organizations-daos)**, trustless network. Here, no single authority—like a central bank—controls the issuance or ledger of transactions. Instead, a distributed community of **miners** and **nodes** maintains the integrity of the system, creating a **peer-to-peer** mechanism for transferring value.
...
1. **Decentralization**  
   - The **[blockchain](/literary_products/joes_notes/CRYPTOGRAPHY_BASICS.md)** is maintained by a global network of participants rather than a central authority.  
...
3. **Fixed Supply**  
   - Bitcoin’s maximum supply is capped at **21 million** coins, influencing its **[store of value](/literary_products/joes_notes/ASSET_CLASSES.md#store-of-value)** narrative.  
...
- **2008–2009**: [Satoshi Nakamoto’s white paper](https://bitcoin.org/bitcoin.pdf) published; the [genesis block](/literary_products/joes_notes/IMPORTANT_DATES_IN_BITCOIN_HISTORY.md#genesis-block) is mined.  
- **2010**: The famous [Bitcoin Pizza Day](/literary_products/joes_notes/IMPORTANT_DATES_IN_BITCOIN_HISTORY.md#bitcoin-pizza-day) exemplifies the first commercial use of Bitcoin.  
...
- **2021**: El Salvador becomes the first country to adopt Bitcoin as [legal tender](/literary_products/joes_notes/IMPORTANT_DATES_IN_BITCOIN_HISTORY.md#2021-el-salvador-and-legal-tender), sparking international discussions on [government adoption](/literary_products/joes_notes/GOVERNMENT_ADOPTION.md).

For a full timeline, see [IMPORTANT_DATES_IN_BITCOIN_HISTORY.md](/literary_products/joes_notes/IMPORTANT_DATES_IN_BITCOIN_HISTORY.md).
...
3. **DeFi Integrations**  
   - **[Wrapped Bitcoin (WBTC)](/literary_products/joes_notes/DEFI_INTRO.md#bitcoin-and-wbtc)** brings BTC liquidity into **Ethereum**-based DeFi protocols, enabling lending, trading, and yield farming.  
...
4. **Remittances and Cross-Border Payments**  
   ...
   - [Public agencies](/literary_products/joes_notes/PUBLIC_AGENCIES.md) and nonprofits have piloted Bitcoin-based remittance programs to reduce fees.
...
1. **Corporations and Financial Institutions**  
   ...
   - **[Exchange-traded funds (ETFs)](/literary_products/joes_notes/FINANCIAL_INNOVATION.md#areas-of-financial-innovation)** based on Bitcoin track its market performance, broadening investor access.

2. **Government Interest**  
   - [El Salvador’s legal tender status](/literary_products/joes_notes/IMPORTANT_DATES_IN_BITCOIN_HISTORY.md#2021-el-salvador-and-legal-tender) raised questions about [monetary policy](/literary_products/joes_notes/FINANCIAL_SYSTEMS.md) and sovereignty.  
   - Other nations evaluate or explore [government adoption](/literary_products/joes_notes/GOVERNMENT_ADOPTION.md), focusing on regulations, taxation, and consumer protection.

3. **Regulatory Landscape**  
   - **[Regulatory frameworks](/literary_products/joes_notes/REGULATORY_FRAMEWORKS.md)** differ worldwide: some countries encourage innovation, others impose strict controls or outright bans.  
...
1. **Volatility**  
   - Bitcoin’s price can fluctuate significantly, affecting its stability as a [store of value](/literary_products/joes_notes/ASSET_CLASSES.md#store-of-value) or [medium of exchange](/literary_products/joes_notes/FINANCIAL_SYSTEMS.md).  
...
4. **Illicit Activities**  
   ...
   - [Public agencies](/literary_products/joes_notes/PUBLIC_AGENCIES.md) and compliance tools now track suspicious addresses, seeking a balance between user privacy and preventing crime.
...
3. **Nation-State Experiments**  
   - Countries grappling with currency instability or high remittance needs may follow El Salvador’s lead, exploring Bitcoin for national-level [public services](/literary_products/joes_notes/PUBLIC_SERVICES.md).  
